...
// source: furya/delegations.proto
...
type FuryaValidatorInfo struct {
...
func (m *FuryaValidatorInfo) Reset()         { *m = FuryaValidatorInfo{} }
func (m *FuryaValidatorInfo) String() string { return proto.CompactTextString(m) }
func (*FuryaValidatorInfo) ProtoMessage()    {}
func (*FuryaValidatorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8303368cab785f76, []int{5}
}
func (m *FuryaValidatorInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FuryaValidatorInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FuryaValidatorInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FuryaValidatorInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FuryaValidatorInfo.Merge(m, src)
}
func (m *FuryaValidatorInfo) XXX_Size() int {
	return m.Size()
}
func (m *FuryaValidatorInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_FuryaValidatorInfo.DiscardUnknown(m)
}

var xxx_messageInfo_FuryaValidatorInfo proto.InternalMessageInfo

func init() {
	proto.RegisterType((*Delegation)(nil), "furya.furya.Delegation")
	proto.RegisterType((*Redelegation)(nil), "furya.furya.Redelegation")
	proto.RegisterType((*QueuedRedelegation)(nil), "furya.furya.QueuedRedelegation")
	proto.RegisterType((*Undelegation)(nil), "furya.furya.Undelegation")
	proto.RegisterType((*QueuedUndelegation)(nil), "furya.furya.QueuedUndelegation")
	proto.RegisterType((*FuryaValidatorInfo)(nil), "furya.furya.FuryaValidatorInfo")
}

func init() { proto.RegisterFile("furya/delegations.proto", fileDescriptor_8303368cab785f76) }
...
func (m *FuryaValidatorInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FuryaValidatorInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FuryaValidatorInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FuryaValidatorInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FuryaValidatorInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FuryaValidatorInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FuryaValidatorInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
