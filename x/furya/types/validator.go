...
type FuryaValidator struct {
	*stakingtypes.Validator
	*FuryaValidatorInfo
}

func NewFuryaValidatorInfo() FuryaValidatorInfo {
	return FuryaValidatorInfo{
...
func (v *FuryaValidator) AddShares(delegationShares sdk.DecCoins, validatorShares sdk.DecCoins) {
...
func (v *FuryaValidator) ReduceShares(delegationShares sdk.DecCoins, validatorShares sdk.DecCoins) {
...
func (v FuryaValidator) TotalSharesWithDenom(denom string) sdk.Dec {
	return sdk.DecCoins(v.TotalDelegatorShares).AmountOf(denom)
}

func (v FuryaValidator) ValidatorSharesWithDenom(denom string) sdk.Dec {
...
func (v FuryaValidator) TotalDelegationSharesWithDenom(denom string) sdk.Dec {
	return sdk.DecCoins(v.TotalDelegatorShares).AmountOf(denom)
}

func (v FuryaValidator) TotalTokensWithAsset(asset FuryaAsset) sdk.Dec {
...
func (v FuryaValidator) TotalDecTokensWithAsset(asset FuryaAsset) sdk.Dec {
	shares := v.ValidatorSharesWithDenom(asset.Denom)
