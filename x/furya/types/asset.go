...
func NewFuryaAsset(denom string, rewardWeight sdk.Dec, takeRate sdk.Dec, rewardStartTime time.Time) FuryaAsset {
	return FuryaAsset{
		Denom:                denom,
...
func GetDelegationTokens(del Delegation, val FuryaValidator, asset FuryaAsset) sdk.Coin {
...
func GetDelegationSharesFromTokens(val FuryaValidator, asset FuryaAsset, token cosmosmath.Int) sdk.Dec {
...
func GetValidatorShares(asset FuryaAsset, token cosmosmath.Int) sdk.Dec {
	return ConvertNewTokenToShares(sdk.NewDecFromInt(asset.TotalTokens), asset.TotalValidatorShares, token)
}

func (a FuryaAsset) HasPositiveDecay() bool {
