...
func init() {
	proto.RegisterType((*Params)(nil), "furya.furya.Params")
	proto.RegisterType((*RewardHistory)(nil), "furya.furya.RewardHistory")
}

func init() { proto.RegisterFile("furya/params.proto", fileDescriptor_3dc4a5b6d277cc53) }
