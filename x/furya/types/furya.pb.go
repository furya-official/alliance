...
// key: denom value: FuryaAsset
type FuryaAsset struct {
...
func (m *FuryaAsset) Reset()         { *m = FuryaAsset{} }
func (m *FuryaAsset) String() string { return proto.CompactTextString(m) }
func (*FuryaAsset) ProtoMessage()    {}
func (*FuryaAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7dbf17f28cd0f90, []int{0}
}
func (m *FuryaAsset) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FuryaAsset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FuryaAsset.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *FuryaAsset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FuryaAsset.Merge(m, src)
}
func (m *FuryaAsset) XXX_Size() int {
	return m.Size()
}
func (m *FuryaAsset) XXX_DiscardUnknown() {
	xxx_messageInfo_FuryaAsset.DiscardUnknown(m)
}

var xxx_messageInfo_FuryaAsset proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*FuryaAsset)(nil), "furya.furya.FuryaAsset")
	proto.RegisterType((*RewardWeightChangeSnapshot)(nil), "furya.furya.RewardWeightChangeSnapshot")
}

func init() { proto.RegisterFile("furya/furya.proto", fileDescriptor_f7dbf17f28cd0f90) }
...
func (m *FuryaAsset) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *FuryaAsset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FuryaAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i -= n1
	i = encodeVarintFurya(dAtA, i, uint64(n1))
	i--
	dAtA[i] = 0x4a
	...
	i -= n2
	i = encodeVarintFurya(dAtA, i, uint64(n2))
	i--
	dAtA[i] = 0x42
	{
		...
		i = encodeVarintFurya(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x3a
	...
	i -= n3
	i = encodeVarintFurya(dAtA, i, uint64(n3))
	i--
	dAtA[i] = 0x32
	{
	...
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintFurya(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintFurya(dAtA []byte, offset int, v uint64) int {
	offset -= sovFurya(v)
	base := offset
	for v >= 1<<7 {
...
func sovFurya(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozFurya(x uint64) (n int) {
	return sovFurya(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *FuryaAsset) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: FuryaAsset: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FuryaAsset: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipFurya(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipFurya(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthFurya
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupFurya
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthFurya        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowFurya          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupFurya = fmt.Errorf("proto: unexpected end of group")
)
