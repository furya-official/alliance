...
func (m MsgServer) Delegate(ctx context.Context, msg *types.MsgDelegate) (*types.MsgDelegateResponse, error) {
	...
	validator, err := m.Keeper.GetFuryaValidator(sdkCtx, valAddr)
	if err != nil {
		return nil, err
	}
...
func (m MsgServer) Redelegate(ctx context.Context, msg *types.MsgRedelegate) (*types.MsgRedelegateResponse, error) {
	...
	srcValidator, err := m.Keeper.GetFuryaValidator(sdkCtx, srcValAddr)
	if err != nil {
		return nil, err
	}

	dstValidator, err := m.Keeper.GetFuryaValidator(sdkCtx, dstValAddr)
	if err != nil {
		return nil, err
	}
