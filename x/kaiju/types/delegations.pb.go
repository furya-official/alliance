...
// source: kaiju/delegations.proto
...
type KaijuValidatorInfo struct {
...
func (m *KaijuValidatorInfo) Reset()         { *m = KaijuValidatorInfo{} }
func (m *KaijuValidatorInfo) String() string { return proto.CompactTextString(m) }
func (*KaijuValidatorInfo) ProtoMessage()    {}
func (*KaijuValidatorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8303368cab785f76, []int{5}
}
func (m *KaijuValidatorInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KaijuValidatorInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KaijuValidatorInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KaijuValidatorInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KaijuValidatorInfo.Merge(m, src)
}
func (m *KaijuValidatorInfo) XXX_Size() int {
	return m.Size()
}
func (m *KaijuValidatorInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_KaijuValidatorInfo.DiscardUnknown(m)
}

var xxx_messageInfo_KaijuValidatorInfo proto.InternalMessageInfo

func init() {
	proto.RegisterType((*Delegation)(nil), "kaiju.kaiju.Delegation")
	proto.RegisterType((*Redelegation)(nil), "kaiju.kaiju.Redelegation")
	proto.RegisterType((*QueuedRedelegation)(nil), "kaiju.kaiju.QueuedRedelegation")
	proto.RegisterType((*Undelegation)(nil), "kaiju.kaiju.Undelegation")
	proto.RegisterType((*QueuedUndelegation)(nil), "kaiju.kaiju.QueuedUndelegation")
	proto.RegisterType((*KaijuValidatorInfo)(nil), "kaiju.kaiju.KaijuValidatorInfo")
}

func init() { proto.RegisterFile("kaiju/delegations.proto", fileDescriptor_8303368cab785f76) }
...
func (m *KaijuValidatorInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KaijuValidatorInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KaijuValidatorInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *KaijuValidatorInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *KaijuValidatorInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KaijuValidatorInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KaijuValidatorInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
