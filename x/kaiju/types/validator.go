...
type KaijuValidator struct {
	*stakingtypes.Validator
	*KaijuValidatorInfo
}

func NewKaijuValidatorInfo() KaijuValidatorInfo {
	return KaijuValidatorInfo{
...
func (v *KaijuValidator) AddShares(delegationShares sdk.DecCoins, validatorShares sdk.DecCoins) {
...
func (v *KaijuValidator) ReduceShares(delegationShares sdk.DecCoins, validatorShares sdk.DecCoins) {
...
func (v KaijuValidator) TotalSharesWithDenom(denom string) sdk.Dec {
	return sdk.DecCoins(v.TotalDelegatorShares).AmountOf(denom)
}

func (v KaijuValidator) ValidatorSharesWithDenom(denom string) sdk.Dec {
...
func (v KaijuValidator) TotalDelegationSharesWithDenom(denom string) sdk.Dec {
	return sdk.DecCoins(v.TotalDelegatorShares).AmountOf(denom)
}

func (v KaijuValidator) TotalTokensWithAsset(asset KaijuAsset) sdk.Dec {
...
func (v KaijuValidator) TotalDecTokensWithAsset(asset KaijuAsset) sdk.Dec {
	shares := v.ValidatorSharesWithDenom(asset.Denom)
