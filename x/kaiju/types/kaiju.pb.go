...
// key: denom value: KaijuAsset
type KaijuAsset struct {
...
func (m *KaijuAsset) Reset()         { *m = KaijuAsset{} }
func (m *KaijuAsset) String() string { return proto.CompactTextString(m) }
func (*KaijuAsset) ProtoMessage()    {}
func (*KaijuAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7dbf17f28cd0f90, []int{0}
}
func (m *KaijuAsset) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KaijuAsset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KaijuAsset.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *KaijuAsset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KaijuAsset.Merge(m, src)
}
func (m *KaijuAsset) XXX_Size() int {
	return m.Size()
}
func (m *KaijuAsset) XXX_DiscardUnknown() {
	xxx_messageInfo_KaijuAsset.DiscardUnknown(m)
}

var xxx_messageInfo_KaijuAsset proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*KaijuAsset)(nil), "kaiju.kaiju.KaijuAsset")
	proto.RegisterType((*RewardWeightChangeSnapshot)(nil), "kaiju.kaiju.RewardWeightChangeSnapshot")
}

func init() { proto.RegisterFile("kaiju/kaiju.proto", fileDescriptor_f7dbf17f28cd0f90) }
...
func (m *KaijuAsset) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *KaijuAsset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KaijuAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i -= n1
	i = encodeVarintKaiju(dAtA, i, uint64(n1))
	i--
	dAtA[i] = 0x4a
	...
	i -= n2
	i = encodeVarintKaiju(dAtA, i, uint64(n2))
	i--
	dAtA[i] = 0x42
	{
		...
		i = encodeVarintKaiju(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x3a
	...
	i -= n3
	i = encodeVarintKaiju(dAtA, i, uint64(n3))
	i--
	dAtA[i] = 0x32
	{
	...
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintKaiju(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintKaiju(dAtA []byte, offset int, v uint64) int {
	offset -= sovKaiju(v)
	base := offset
	for v >= 1<<7 {
...
func sovKaiju(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozKaiju(x uint64) (n int) {
	return sovKaiju(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *KaijuAsset) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: KaijuAsset: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KaijuAsset: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipKaiju(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipKaiju(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthKaiju
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupKaiju
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthKaiju        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowKaiju          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupKaiju = fmt.Errorf("proto: unexpected end of group")
)
