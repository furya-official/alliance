...
func init() {
	proto.RegisterType((*MsgDelegate)(nil), "kaiju.kaiju.MsgDelegate")
	proto.RegisterType((*MsgDelegateResponse)(nil), "kaiju.kaiju.MsgDelegateResponse")
	proto.RegisterType((*MsgUndelegate)(nil), "kaiju.kaiju.MsgUndelegate")
	proto.RegisterType((*MsgUndelegateResponse)(nil), "kaiju.kaiju.MsgUndelegateResponse")
	proto.RegisterType((*MsgRedelegate)(nil), "kaiju.kaiju.MsgRedelegate")
	proto.RegisterType((*MsgRedelegateResponse)(nil), "kaiju.kaiju.MsgRedelegateResponse")
	proto.RegisterType((*MsgClaimDelegationRewards)(nil), "kaiju.kaiju.MsgClaimDelegationRewards")
	proto.RegisterType((*MsgClaimDelegationRewardsResponse)(nil), "kaiju.kaiju.MsgClaimDelegationRewardsResponse")
}

func init() { proto.RegisterFile("kaiju/tx.proto", fileDescriptor_ddcb3ed838213b4a) }
...
func (c *msgClient) Delegate(ctx context.Context, in *MsgDelegate, opts ...grpc.CallOption) (*MsgDelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.kaiju.Msg/Delegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Redelegate(ctx context.Context, in *MsgRedelegate, opts ...grpc.CallOption) (*MsgRedelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.kaiju.Msg/Redelegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Undelegate(ctx context.Context, in *MsgUndelegate, opts ...grpc.CallOption) (*MsgUndelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.kaiju.Msg/Undelegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimDelegationRewards(ctx context.Context, in *MsgClaimDelegationRewards, opts ...grpc.CallOption) (*MsgClaimDelegationRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.kaiju.Msg/ClaimDelegationRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Delegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.kaiju.Msg/Delegate",
	}
...
func _Msg_Redelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.kaiju.Msg/Redelegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Undelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.kaiju.Msg/Undelegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClaimDelegationRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.kaiju.Msg/ClaimDelegationRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
