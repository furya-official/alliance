...
type ValidatorInfoState struct {
	...
	Validator        KaijuValidatorInfo `protobuf:"bytes,2,opt,name=validator,proto3" json:"validator"`
}
...
func (m *ValidatorInfoState) GetValidator() KaijuValidatorInfo {
	if m != nil {
		return m.Validator
	}
...
type GenesisState struct {
	...
	Assets                     []KaijuAsset                   `protobuf:"bytes,2,rep,name=assets,proto3" json:"assets"`
...
func (m *GenesisState) GetAssets() []KaijuAsset {
	if m != nil {
		return m.Assets
	}
	return nil
...
func init() {
	proto.RegisterType((*ValidatorInfoState)(nil), "kaiju.kaiju.ValidatorInfoState")
	proto.RegisterType((*RedelegationState)(nil), "kaiju.kaiju.RedelegationState")
	proto.RegisterType((*UndelegationState)(nil), "kaiju.kaiju.UndelegationState")
	proto.RegisterType((*RewardWeightChangeSnapshotState)(nil), "kaiju.kaiju.RewardWeightChangeSnapshotState")
	proto.RegisterType((*GenesisState)(nil), "kaiju.kaiju.GenesisState")
}

func init() { proto.RegisterFile("kaiju/genesis.proto", fileDescriptor_e04f4ac99abd5245) }
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Assets = append(m.Assets, KaijuAsset{})
