...
func init() {
	proto.RegisterType((*Params)(nil), "kaiju.kaiju.Params")
	proto.RegisterType((*RewardHistory)(nil), "kaiju.kaiju.RewardHistory")
}

func init() { proto.RegisterFile("kaiju/params.proto", fileDescriptor_3dc4a5b6d277cc53) }
