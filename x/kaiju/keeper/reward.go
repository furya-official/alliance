...
func (k Keeper) ClaimValidatorRewards(ctx sdk.Context, val types.KaijuValidator) (sdk.Coins, error) {
...
func (k Keeper) ClaimDelegationRewards(ctx sdk.Context, delAddr sdk.AccAddress, val types.KaijuValidator, denom string) (sdk.Coins, error) {
...
func (k Keeper) CalculateDelegationRewards(ctx sdk.Context, delegation types.Delegation, val types.KaijuValidator, asset types.KaijuAsset) (sdk.Coins, types.RewardHistories, error) {
...
func accumulateRewards(latestRewardHistories types.RewardHistories, rewardHistories types.RewardHistories, asset types.KaijuAsset, rewardWeight sdk.Dec, delegation types.Delegation, validator types.KaijuValidator) (sdk.Coins, types.RewardHistories) {
...
// To calculate the number of rewards claimable, take reward_history * kaiju_token_amount * reward_weight
func (k Keeper) AddAssetsToRewardPool(ctx sdk.Context, from sdk.AccAddress, val types.KaijuValidator, coins sdk.Coins) error {
...
func (k Keeper) totalAssetWeight(ctx sdk.Context, val types.KaijuValidator) sdk.Dec {
	total := sdk.ZeroDec()
