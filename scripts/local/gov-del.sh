...
printf "#1) Submit proposal to delete the ufuryx Furya...\n\n"
furyad tx gov submit-legacy-proposal delete-furya ufuryx --from=demowallet1 --home ./data/furya --keyring-backend=test --broadcast-mode=block --gas 1000000 -y > /dev/null 2>&1
