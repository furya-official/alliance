...
printf "#1) Submit proposal to delete the ukaijux Kaiju...\n\n"
kaijud tx gov submit-legacy-proposal delete-kaiju ukaijux --from=demowallet1 --home ./data/kaiju --keyring-backend=test --broadcast-mode=block --gas 1000000 -y > /dev/null 2>&1
