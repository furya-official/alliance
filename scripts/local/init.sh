...
# furya1phaxpevm5wecex2jyaqty2a4v02qj7qm24tyvq / furyavaloper1phaxpevm5wecex2jyaqty2a4v02qj7qmut9cku
...
# furya1cyyzpxplxdzkeea7kwsydadg87357qnaznl0wd
...
FURYA_CLAIM_REWARDS="5s"


# Stop if it is already running 
if pgrep -x "furyad" >/dev/null; then
    echo "Terminating furyad..."
    killall furyad
fi
...
furyad init test --home $CHAIN_DIR/$CHAINID --chain-id=$CHAINID

echo "Adding genesis accounts..."
echo $VAL_MNEMONIC_1 | furyad keys add val1 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_1 | furyad keys add demowallet1 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_2 | furyad keys add demowallet2 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_3 | furyad keys add demowallet3 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_4 | furyad keys add demowallet4 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test

furyad add-genesis-account $(furyad --home $CHAIN_DIR/$CHAINID keys show val1 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000ufuryx  --home $CHAIN_DIR/$CHAINID
furyad add-genesis-account $(furyad --home $CHAIN_DIR/$CHAINID keys show demowallet1 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000ufuryx  --home $CHAIN_DIR/$CHAINID
furyad add-genesis-account $(furyad --home $CHAIN_DIR/$CHAINID keys show demowallet2 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000ufuryx  --home $CHAIN_DIR/$CHAINID
furyad add-genesis-account $(furyad --home $CHAIN_DIR/$CHAINID keys show demowallet3 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000ufuryx  --home $CHAIN_DIR/$CHAINID
furyad add-genesis-account $(furyad --home $CHAIN_DIR/$CHAINID keys show demowallet4 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000ufuryx  --home $CHAIN_DIR/$CHAINID

echo "Creating and collecting gentx..."
furyad gentx val1 7000000000${STAKEDENOM} --home $CHAIN_DIR/$CHAINID --chain-id $CHAINID --keyring-backend test
furyad collect-gentxs --home $CHAIN_DIR/$CHAINID
...
## FURYA
sed -i -e "s/\"reward_claim_interval\": \"300s\"/\"reward_claim_interval\": \"$FURYA_CLAIM_REWARDS\"/g" $CHAIN_DIR/$CHAINID/config/genesis.json
sed -i -e "s/\"reward_delay_time\": \"86400s\"/\"reward_delay_time\": \"$FURYA_CLAIM_REWARDS\"/g" $CHAIN_DIR/$CHAINID/config/genesis.json


echo "Genesis event created with $STAKEDENOM and ufuryx"